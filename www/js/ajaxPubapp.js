 ...
 */
 function  getHttpResponse(serverUrl,flag,info) {
	 ...
	 //serverIp = serverIp +":8081";
	  
	 //serverIp = "121.36.38.143:38019";//华青访问地址
	 //serverIp = "124.227.9.83:8081";//南宁四职校访问地址 admin Nnszx2019
	 //serverIp = "39.105.211.59:9001";//服务器9001地址
	 serverIp = "71.146.5.171:8081";//贵港公安访问地址 
	      
	 var sessionId = window.localStorage.getItem("sessionId");
	 if(flag=="login")
	    serverUrl = "http://"+serverIp+serverUrl;
	 else
		  serverUrl = "http://"+serverIp+serverUrl+";jsessionid="+sessionId; 		
